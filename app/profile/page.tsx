	...
	return (
		<div className="profile flex flex-col items-center">
			...
			<div className="w-72 h-72 bg-lightBlue rounded-full border-black border-solid flex items-center flex-col overflow-hidden pt-20">
				<Image
					src={"/assets/profile-image-top.svg"}
					alt="profileImage"
					width={93}
					height={93}
				/>
			...
			<p className="text-2xl mt-4 text-lightYellow font-black not-italic tracking-wide">
				Alison Smith
			</p>
			<p className="text-center text-sm font-normal not-italic mx-16 mt-1.5">
				Earn more points to unlock rewards and support sustainable initiatives
			</p>
			<p className="text-2xl text-lightYellow font-black not-italic tracking-wide w-full pl-4 mt-10 mb-2.5">
				Your Goals
			</p>
